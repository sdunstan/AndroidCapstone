...
//            new ConfirmationDialog().show(getChildFragmentManager(), CameraConstants.FRAGMENT_DIALOG);
            ...
            requestPermissions(CameraConstants.VIDEO_PERMISSIONS, CameraConstants.REQUEST_VIDEO_PERMISSIONS);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == CameraConstants.REQUEST_VIDEO_PERMISSIONS) {
...
//                                .show(getChildFragmentManager(), CameraConstants.FRAGMENT_DIALOG);
                        Log.e(TAG, "Error requesting video permissions " + result);
                        break;
                    }
                }
            } else {
    ...
    private boolean isFrontFacing(CameraCharacteristics characteristics) {
        Integer facing = characteristics.get(CameraCharacteristics.LENS_FACING);
        return (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT);
    }

    private String findFrontFacingCamera(CameraManager manager) throws CameraAccessException {
    ...
    private void stopRecordingVideo() {
        ...
        Line recordedLine = currentLine.addVideoUrl(mNextVideoAbsolutePath);
