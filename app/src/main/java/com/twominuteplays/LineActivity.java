...
public class LineActivity extends BaseActivity {
    ...
    private class RecordVideoClickHandler implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            StringBuilder fileName = new StringBuilder(line.getId());
            fileName.append("-").append(new Date().getTime()).append(".mp4");
            mOutputFile = new File(getMediaDirectory(), fileName.toString());
//            Uri outputFileUri = FileProvider.getUriForFile(LineActivity.this, "com.twominuteplays", mOutputFile);
            Uri outputFileUri = Uri.fromFile(mOutputFile);
//            Log.d(TAG, "Creating movie file " + outputFileUri.toString());
//            cameraIntent.setClipData(ClipData.newRawUri("line", outputFileUri));
